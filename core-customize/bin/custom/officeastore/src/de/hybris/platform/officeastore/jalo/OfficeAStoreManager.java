 ...
 */
package de.hybris.platform.officeastore.jalo;
...
/**
 * This is the extension manager of the OfficeAstore extension.
 */
public class OfficeAStoreManager extends GeneratedOfficeAStoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(OfficeAStoreManager.class.getName());
	 ...
	 */
	public static OfficeAStoreManager getInstance()
	{
		return (OfficeAStoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OfficeAStoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OfficeAStoreManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OfficeAStoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OfficeAStoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OfficeAStoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
