 ...
 */
package de.hybris.platform.officeastore.services.dataimport.impl;

import de.hybris.platform.commerceservices.dataimport.impl.CoreDataImportService;


/**
 * Implementation to handle specific Core Data Import services to OfficeA.
 */
public class OfficeACoreDataImportService extends CoreDataImportService
{
	/**
	 * Imports store data related to OfficeA. Imports a site-override impex if available.
	 *
	 * @param extensionName
