 ...
 */
package org.eyglobalb2b.storefront.controllers.pages.checkout.steps;
...
import org.eyglobalb2b.storefront.controllers.ControllerConstants;
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		if (CheckoutPciOptionEnum.HOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				if(receiptResponseURL.contains("officea") && receiptResponseURL.contains("8088"))
				{
					declineResponseURL = declineResponseURL.replace("localhost:8088/eyglobalb2bstorefront", "officea.cuo2c7ilx-eyglobals2-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2bstorefront");
					merchantURLPostAddress = merchantURLPostAddress.replace("localhost:8088/eyglobalb2bstorefront", "officea.cuo2c7ilx-eyglobals2-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2bstorefront");
					receiptResponseURL = receiptResponseURL.replace("localhost:8088/eyglobalb2bstorefront", "officea.cuo2c7ilx-eyglobals2-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2bstorefront");
					cancelResponseURL = cancelResponseURL.replace("localhost:8088/eyglobalb2bstorefront", "officea.cuo2c7ilx-eyglobals2-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2bstorefront");
				}
