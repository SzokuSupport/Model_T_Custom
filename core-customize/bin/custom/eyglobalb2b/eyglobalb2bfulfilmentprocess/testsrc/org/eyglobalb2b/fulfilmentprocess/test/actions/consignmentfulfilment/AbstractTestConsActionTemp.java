 ...
 */
package org.eyglobalb2b.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Eyglobalb2bFulfilmentProcessConstants.PARENT_PROCESS);
