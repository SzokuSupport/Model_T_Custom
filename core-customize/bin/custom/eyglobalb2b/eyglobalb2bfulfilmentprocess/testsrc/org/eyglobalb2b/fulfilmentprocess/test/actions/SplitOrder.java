 ...
 */
package org.eyglobalb2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Eyglobalb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Eyglobalb2bFulfilmentProcessConstants.PARENT_PROCESS);
