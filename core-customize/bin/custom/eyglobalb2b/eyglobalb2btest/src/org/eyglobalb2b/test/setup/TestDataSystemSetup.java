 ...
 */
package org.eyglobalb2b.test.setup;
...
import org.eyglobalb2b.test.constants.Eyglobalb2bTestConstants;
import org.eyglobalb2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Eyglobalb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eyglobalb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eyglobalb2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/eyglobalb2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/eyglobalb2btest/import/csquotes.impex");
		}
	}
}
