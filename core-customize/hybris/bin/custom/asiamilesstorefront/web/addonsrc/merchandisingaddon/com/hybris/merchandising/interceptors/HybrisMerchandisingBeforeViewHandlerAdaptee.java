...
public class HybrisMerchandisingBeforeViewHandlerAdaptee implements BeforeViewHandlerAdaptee
{
	...
	{
		final Optional<Object> searchPageDataOptional = Optional.ofNullable(model.get(SEARCH_PAGE_DATA));
		if(searchPageDataOptional.isPresent())
		{
			if (searchPageDataOptional.get() instanceof ProductCategorySearchPageData)
			{
