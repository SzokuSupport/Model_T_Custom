...
function addASMHandlers() {
    ...
    if ($("#asmLogoutBtn").length) {
    	idpLogoutUrl = $("#logoutUrl").val();
    	idpKeepaliveUrl = $("#asmKeepaliveUrl").val();
    	$("#asmLogoutBtn").click(function() {
...
$( document ).ready(function() {
    ...
    //if IDP logged in when the page refreshed then call the IDP keepalive api.
	if(idpKeepaliveUrl.length > 1){
		$.ajax({
	        url : idpKeepaliveUrl,
	        type : "GET",
	        success: function(data) {
...
//	}
	$.ajax({
        ...
        type : "POST",
        success: function(data) {
        	window.location.replace(idpLogoutUrl+"?logout_redirect_uri="+window.location.protocol+"//"+window.location.host+"?asm=true");
        }
    });
}
