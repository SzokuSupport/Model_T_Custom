...
<div class="display-details">
	<div class="store-tabs js-pickup-tabs">
		<div class="tabhead" tabindex='0' aria-label="<spring:theme code='storeDetails.title'/>">
		...
		<div class="tabhead js-pickup-map-tab" tabindex='0' aria-label="<spring:theme code="storeDetails.map.link"/>">
