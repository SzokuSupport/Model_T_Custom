...
<div class="step-one__recipient">
	<div class="step-one__recipient--left">
		<span><spring:theme code="asiamiles.check.out.stype.nav.recipient.details"/></span>
	</div>
	<input type="hidden" name="deliverTo" value="self">
	<div class="row step-one__recipient--right">
		<div class="col-lg-12 col-sm-12">
			<checkout:amlTitle titles = "${DeliveryInfo.titles}" title="${recipientInfo.title}"/>
			<div class="input-component J-input-transform">
				<input type="text" id="familyName" name="familyName" value="${recipientInfo.familyName}" />
					<label class=" placeholder J-input-placeholder" for="familyName"><spring:theme code="asiamiles.check.out.stype.nav.recipient.family.name"/></label>
			...
			<div class="input-component J-input-transform">
				<input type="text" id="givenName" name="givenName" value="${recipientInfo.givenName}" />
					<label class=" placeholder J-input-placeholder" for="givenName"><spring:theme code="asiamiles.check.out.stype.nav.recipient.given.name"/></label>
				<div class="errorBox J-error-box">
					<div class="errorMes">
						<svg class="icon-warning" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							<g fill="none" fill-rule="evenodd">
		...
		<div class="col-lg-6 col-sm-6">
			<div class="dropdown-group__checkOut J-country-code">
				<label for="capacity" class="dropdown-label"><spring:theme code ="asiamiles.check.out.stype.nav.recipient.country.and.code"/></label>
				...
				<!-- /desktop dropdown -->
				<!-- mobile dropdown -->
				<select class="dropdown-selected-control--mobile J-selectedControlMobile" id="cuntryListBoxPhone" name="title" use="y">
					<c:forEach items="${phoneCountryCode}" var="phoneCountry">
						<c:if test="${recipientInfo.countryCode==phoneCountry.phoneCode}">
		...
		<div class="col-lg-6 col-sm-6">
			<div class="input-component J-input-transform">
				<input type="text" id="phone" name="recipientPhoneNo" aria-label="Mobile phone number" value="${recipientInfo.phoneNo}"/>
				<label class="placeholder J-input-placeholder" for="phone" aria-hidden='true'><spring:theme code="asiamiles.check.out.stype.nav.recipient.phone"/></label>
				<div class="errorBox J-error-box">
					<div class="errorMes">
						<svg class="icon-warning" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							<g fill="none" fill-rule="evenodd">
