 ...
 <body>
	...
	<form:form id="J-place-order" action="${placeOrderUrl}" method="post" commandName="placeOrderForm">
	    <div class="delivery-address">
	   		<input
<%!
class="form-item" name="addressForm.addressId" type="hidden" value="${placeOrderForm.baseInfo.firstName}">
		    ...
		    <div class="delivery-address-content">
		        <div class="form">
		            ...
		            <input class="form-item" name="addressForm.firstName" type="text" value="${deliveryInfo.addressForm.firstName}">
		        </div>
		        <div class="form">
			                    ...
			                    <div class="item-type">
									...
									<c:if test="${not empty timeVariantValue or not empty seatVariantValue}">
										<c:if test="${not empty timeVariantValue}">
											<span class="detail">Time: <b>${timeVariantValue}</b></span> 
										</c:if>
										<c:if test="${not empty seatVariantValue}">
											<span class="detail">Seat: <b>${seatVariantValue}</b></span> 
										</c:if>
									</c:if>
									<div>
			                            <span>Avaliable Country: <b>Hong Kong</b></span>
			                        </div>
