...
<script src="${adobleAnalysisPath}" async></script>
...
<%--  Cookie Consent Bar CSS files --%>
<c:if test="${not empty cookieConsentJs and not empty cookieConsentCss}">
	<link rel="stylesheet" type="text/css" href="${cookieConsentCss }" media="all"> 
</c:if>
<!-- <link href="/_ui/addons/asiamilesasmaddon/responsive/common/css/customer360.css" rel="stylesheet"> -->
...
<%-- </c:if> --%>
<!-- <link href="/_ui/addons/asiamilesasmaddon/responsive/common/css/asiamilesasmaddon.css" rel="stylesheet"> -->
