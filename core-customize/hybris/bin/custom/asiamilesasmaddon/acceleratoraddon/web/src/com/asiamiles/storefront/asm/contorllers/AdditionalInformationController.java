...
public class AdditionalInformationController
{
	...
	private static final String CUSTOMER_360_PAGE = "addon:/asiamilesasmaddon/pages/customer360";
	private static final String CUSTOMER_360_FRAGMENT_404_PAGE = "addon:/asiamilesasmaddon/fragments/customer360/fragment404";
	private static final String CUSTOMER_360_SECTION = "addon:/asiamilesasmaddon/pages/section";
	...
	public String getCustomer360(final Model model, final HttpServletResponse response)
	{
		...
		model.addAttribute("sections", this.additionalInformationFrameworkFacade.getSections());
			...
			@RequestParam("sectionId") final String sectionId, final HttpServletResponse response)
	{
		...
		model.addAttribute("section", this.additionalInformationFrameworkFacade.getSection(sectionId));
			...
			@RequestParam final Map<String, String> allRequestParams, final HttpServletResponse response)
	{
		...
		final Fragment populatedFragment = this.additionalInformationFrameworkFacade.getFragment(sectionId, fragmentId,
				allRequestParams);
