                    ...
                    <div id="_asmLogged" class="ASM_loggedin">
                        ...
                        <div class="ASM_loggedin_text element-separator-height">
                            ...
                            <form action="${logoutActionUrl}" method="post" id="asmLogoutForm" class="asmForm">
                            		<input type="hidden" id="asmKeepaliveUrl" value="${asmKeepaliveUrl}">
                            		<input type="hidden" id="logoutUrl" value="${asmLogoutUrl}">
                                <fieldset>
                                    <button type="button" id="asmLogoutBtn" class="ASM-btn ASM-btn-logout" disabled><spring:theme code="asm.logout"/></button>
                                </fieldset>
                            </form>
                        </div>
                    </div>
