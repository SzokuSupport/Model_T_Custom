...
<em>smarteditsso/web/features/smarteditssoContainer/smarteditssocontainermodule.ts</em>
```ts
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the smarteditsso:
- <em>smarteditsso/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>smarteditsso/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'smarteditsso' layer of smarteditsso is a bundle of smarteditsso and smarteditssocommons.
The 'smarteditssoContainer' layer of smarteditsso is a bundle of smarteditssoContainer and smarteditssocommons.
