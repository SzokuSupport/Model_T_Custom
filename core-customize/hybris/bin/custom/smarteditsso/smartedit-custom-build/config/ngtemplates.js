...
module.exports = function() {
    ...
    return {
        ...
        config: function(data, conf) {
            ...
            conf.smarteditsso = generateConfigForFolder('smarteditsso');
            conf.smarteditssocommons = generateConfigForFolder('smarteditssocommons');
            conf.smarteditssoContainer = generateConfigForFolder('smarteditssoContainer');
