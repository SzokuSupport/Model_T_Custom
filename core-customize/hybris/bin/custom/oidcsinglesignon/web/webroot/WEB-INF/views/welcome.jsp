...
<html>
<head>
    <title>Welcome to oidcsinglesignon</title>
...
<div class="container">
    ...
    <h2>Welcome to "oidcsinglesignon" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/oidcsinglesignon-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/oidcsinglesignon-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/oidcsinglesignon-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/oidcsinglesignon-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/oidcsinglesignon-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
