 ...
 */
package de.hybris.eyglobal.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Eyglobalb2cFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Eyglobalb2cFulfilmentProcessConstants.PARENT_PROCESS);
