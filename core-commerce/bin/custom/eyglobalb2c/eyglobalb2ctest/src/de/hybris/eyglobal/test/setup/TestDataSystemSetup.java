 ...
 */
package de.hybris.eyglobal.test.setup;
...
import de.hybris.eyglobal.test.constants.Eyglobalb2cTestConstants;
import de.hybris.eyglobal.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Eyglobalb2cTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eyglobalb2ctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eyglobalb2ctest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/eyglobalb2ctest/import/cstickets.impex");
			...
			importImpexFile(context, "/eyglobalb2ctest/import/csquotes.impex");
		}
	}
}
