 ...
 */
package de.hybris.eyglobal.storefront.controllers.pages.checkout.steps;
...
import de.hybris.eyglobal.storefront.controllers.ControllerConstants;
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		if (CheckoutPciOptionEnum.HOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				//Customization - EY Raymond Nathan
					String declineResponseURL = hostedOrderPageData.getParameters().get("orderPage_declineResponseURL");
					String merchantURLPostAddress = hostedOrderPageData.getParameters().get("orderPage_merchantURLPostAddress");
					String receiptResponseURL = hostedOrderPageData.getParameters().get("orderPage_receiptResponseURL");
					String cancelResponseURL = hostedOrderPageData.getParameters().get("orderPage_cancelResponseURL");

					if(receiptResponseURL.contains("cosmetics") && receiptResponseURL.contains("8088"))
					{
						declineResponseURL = declineResponseURL.replace("localhost:8088/eyglobalb2cstorefront", "cosmetics.cuo2c7ilx-eyglobals1-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2cstorefront");
						merchantURLPostAddress = merchantURLPostAddress.replace("localhost:8088/eyglobalb2cstorefront", "cosmetics.cuo2c7ilx-eyglobals1-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2cstorefront");
						receiptResponseURL = receiptResponseURL.replace("localhost:8088/eyglobalb2cstorefront", "cosmetics.cuo2c7ilx-eyglobals1-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2cstorefront");
						cancelResponseURL = cancelResponseURL.replace("localhost:8088/eyglobalb2cstorefront", "cosmetics.cuo2c7ilx-eyglobals1-d1-public.model-t.cc.commerce.ondemand.com/eyglobalb2cstorefront");
					}

					hostedOrderPageData.getParameters().put("orderPage_declineResponseURL",declineResponseURL);
					hostedOrderPageData.getParameters().put("orderPage_merchantURLPostAddress",merchantURLPostAddress);
					hostedOrderPageData.getParameters().put("orderPage_receiptResponseURL",receiptResponseURL);
					hostedOrderPageData.getParameters().put("orderPage_cancelResponseURL",cancelResponseURL);
				//Customization - EY Raymond Nathan
