 ...
 */
package de.hybris.platform.cosmeticsstore.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.cosmeticsstore.constants.CosmeticsStoreConstants;
...
/**
 * This is the extension manager of the Cosmeticsstore extension.
 */
public class CosmeticsStoreManager extends GeneratedCosmeticsStoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(CosmeticsStoreManager.class.getName());
	 ...
	 */
	public CosmeticsStoreManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CosmeticsstoreManager called.");
		}
	}
	 ...
	 */
	public static CosmeticsStoreManager getInstance()
	{
		return (CosmeticsStoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CosmeticsStoreConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CosmeticsstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CosmeticsstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
